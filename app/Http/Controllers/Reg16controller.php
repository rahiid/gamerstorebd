...
class Reg16controller extends Controller
{
    /**
    ...
    {
        $reg16 = Reg16::all()->toArray();
        $csorregular = DB::table('card16')->where('status', 'upcoming')->value('cs_or_regular');
        
        return view('/match-reg.reg16', compact('reg16','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card16')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg16');
    }
