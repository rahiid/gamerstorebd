...
class Reg11controller extends Controller
{
    /**
    ...
    {
        $reg11 = Reg11::all()->toArray();

        $csorregular = DB::table('card11')->where('status', 'upcoming')->value('cs_or_regular');

        return view('/match-reg.reg11', compact('reg11','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card11')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg11');
    }
