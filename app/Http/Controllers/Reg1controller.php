...
class Reg1controller extends Controller
{
    /**
    ...
    {
        $reg1 = Reg1::all()->toArray();
        $card1  = Card1::all()->toArray();
        $csorregular = DB::table('card1')->where('status', 'upcoming')->value('cs_or_regular');

        return view('/match-reg.reg1', compact('reg1','card1','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card1')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg1');
    }
