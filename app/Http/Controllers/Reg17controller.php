...
class Reg17controller extends Controller
{
    /**
    ...
    {
        $reg17 = Reg17::all()->toArray();
        $csorregular = DB::table('card17')->where('status', 'upcoming')->value('cs_or_regular');

        return view('/match-reg.reg17', compact('reg17','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card17')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg17');
    }
