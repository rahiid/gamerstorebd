...
class Reg8controller extends Controller
{
    /**
    ...
    {
        $reg8 = Reg8::all()->toArray();

        $csorregular = DB::table('card8')->where('status', 'upcoming')->value('cs_or_regular');

        return view('/match-reg.reg8', compact('reg8','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card8')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg8');
    }
