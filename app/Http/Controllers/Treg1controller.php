...
class Treg1controller extends Controller
{
    /**
    ...
    {
        $treg1 = Treg1::all()->toArray();
        $csorregular = DB::table('tcard1')->where('status', 'upcoming')->value('cs_or_regular');

        return view('/tournament-reg.treg1', compact('treg1','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('tcard1')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/tournament-reg/treg1');
    }
