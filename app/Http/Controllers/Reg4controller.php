...
class Reg4controller extends Controller
{
    /**
    ...
    {
        $reg4 = Reg4::all()->toArray();
        $csorregular = DB::table('card4')->where('status', 'upcoming')->value('cs_or_regular');

        return view('/match-reg.reg4', compact('reg4','csorregular'));
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card4')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg4');
    }
