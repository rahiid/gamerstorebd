...
class Treg4controller extends Controller
{
    /**
    ...
    {
        $treg4 = Treg4::all()->toArray();
        $csorregular = DB::table('tcard4')->where('status', 'upcoming')->value('cs_or_regular');

        return view('/tournament-reg.treg4', compact('treg4','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('tcard4')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/tournament-reg/treg4');
    }
