...
class Reg9controller extends Controller
{
    /**
    ...
    {
        $reg9 = Reg9::all()->toArray();
        $csorregular = DB::table('card9')->where('status', 'upcoming')->value('cs_or_regular');

        return view('/match-reg.reg9', compact('reg9','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card9')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg9');
    }
