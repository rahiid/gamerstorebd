...
class Reg2controller extends Controller
{
    ...
    {
        $reg2 = Reg2::all()->toArray();
        $csorregular = DB::table('card2')->where('status', 'upcoming')->value('cs_or_regular');

        return view('/match-reg.reg2', compact('reg2','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card2')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg2');
    }
