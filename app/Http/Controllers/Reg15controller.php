...
class Reg15controller extends Controller
{
    /**
    ...
    {
        $reg15 = Reg15::all()->toArray();

        $csorregular = DB::table('card15')->where('status', 'upcoming')->value('cs_or_regular');

        return view('/match-reg.reg15', compact('reg15','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card15')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg15');
    }
