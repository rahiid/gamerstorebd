...
class Reg18controller extends Controller
{
    /**
    ...
    {
        $reg18 = Reg18::all()->toArray();
        $csorregular = DB::table('card18')->where('status', 'upcoming')->value('cs_or_regular');

        return view('/match-reg.reg18', compact('reg18','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card18')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg18');
    }
