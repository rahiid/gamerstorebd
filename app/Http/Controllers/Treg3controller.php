...
class Treg3controller extends Controller
{
    /**
    ...
    {
        $treg3 = Treg3::all()->toArray();
        $csorregular = DB::table('tcard3')->where('status', 'upcoming')->value('cs_or_regular');

        return view('/tournament-reg.treg3', compact('treg3','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('tcard3')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/tournament-reg/treg3');
    }
