...
class Reg7controller extends Controller
{
    /**
    ...
    {
        $reg7 = Reg7::all()->toArray();
        $csorregular = DB::table('card7')->where('status', 'upcoming')->value('cs_or_regular');
        
        return view('/match-reg.reg7', compact('reg7','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card7')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg7');
    }
