...
class Reg20controller extends Controller
{
    /**
    ...
    {
        $reg20 = Reg20::all()->toArray();
        $csorregular = DB::table('card20')->where('status', 'upcoming')->value('cs_or_regular');
        return view('/match-reg.reg20', compact('reg20','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card20')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg20');
    }
