...
class Reg13controller extends Controller
{
    /**
    ...
    {
        $reg13 = Reg13::all()->toArray();
        $csorregular = DB::table('card13')->where('status', 'upcoming')->value('cs_or_regular');

        return view('/match-reg.reg13', compact('reg13','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card13')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg13');
    }
