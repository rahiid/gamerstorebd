...
class Reg12controller extends Controller
{
    /**
    ...
    {
        $reg12 = Reg12::all()->toArray();
        $csorregular = DB::table('card12')->where('status', 'upcoming')->value('cs_or_regular');

        return view('/match-reg.reg12', compact('reg12','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card12')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg12');
    }
