...
class Reg5controller extends Controller
{
    /**
    ...
    {
        $reg5 = Reg5::all()->toArray();
        $csorregular = DB::table('card5')->where('status', 'upcoming')->value('cs_or_regular');
        return view('/match-reg.reg5', compact('reg5','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card5')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg5');
    }
