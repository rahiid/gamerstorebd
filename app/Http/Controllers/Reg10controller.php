...
class Reg10controller extends Controller
{
    /**
    ...
    {
        $reg10 = Reg10::all()->toArray();
        $csorregular = DB::table('card10')->where('status', 'upcoming')->value('cs_or_regular');
        return view('/match-reg.reg10', compact('reg10','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card10')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg10');
    }
