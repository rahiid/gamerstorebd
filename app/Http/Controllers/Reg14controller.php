...
class Reg14controller extends Controller
{
    /**
    ...
    {
        $reg14 = Reg14::all()->toArray();
        $csorregular = DB::table('card14')->where('status', 'upcoming')->value('cs_or_regular');

        return view('/match-reg.reg14', compact('reg14','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card14')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg14');
    }
