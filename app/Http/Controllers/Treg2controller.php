...
class Treg2controller extends Controller
{
    /**
    ...
    {
        $treg2 = Treg2::all()->toArray();
        $csorregular = DB::table('tcard2')->where('status', 'upcoming')->value('cs_or_regular');
        return view('/tournament-reg.treg2', compact('treg2','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('tcard2')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/tournament-reg/treg2');
    }
