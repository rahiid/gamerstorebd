...
class Treg5controller extends Controller
{
    /**
    ...
    {
        $treg5 = Treg5::all()->toArray();
        $csorregular = DB::table('tcard5')->where('status', 'upcoming')->value('cs_or_regular');
        return view('/tournament-reg.treg5', compact('treg5','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('tcard5')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/tournament-reg/treg5');
    }
