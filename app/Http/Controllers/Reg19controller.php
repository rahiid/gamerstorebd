...
class Reg19controller extends Controller
{
    /**
    ...
    {
        $reg19 = Reg19::all()->toArray();
        $csorregular = DB::table('card19')->where('status', 'upcoming')->value('cs_or_regular');
        return view('/match-reg.reg19', compact('reg19','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card19')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg19');
    }
