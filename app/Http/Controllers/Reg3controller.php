...
class Reg3controller extends Controller
{
    /**
    ...
    {
        $reg3 = Reg3::all()->toArray();
        $csorregular = DB::table('card3')->where('status', 'upcoming')->value('cs_or_regular');

        return view('/match-reg.reg3', compact('reg3','csorregular'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cardvalue = DB::table('card3')->where('status', 'upcoming')->value('entry_fee');
        ...
        return redirect('/match-reg/reg3');
