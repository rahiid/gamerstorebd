                ...
                <div id="backgroundImage" class="banner-top-up">
                    <div class="card mb-3">
                         <div class="row no-gutters banner-inner">
                           ...
                           <div class="col-md-2">
                             <img src="/image/c4.jpg" class="card-img" alt="banner-image">
                           </div>
                           <div class="col-md-9 card-right"    style="text-align: justify;">
                             <div class="card-body">
                               <h5 class="card-title">Call of Duty: Mobile</h5>
                               <p class="card-text">Call of Duty: Mobile is a free-to-play shooter video game developed by TiMi Studios and published by Activision for Android and iOS.</p>
                               <p class="card-text"><medium class="text-muted">Region	EA <br>Platform	Mobile <br>Publisher Activision Garena Online ® </medium></p>
                             </div>
                           </div>
                         </div>
                       </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form name="game-form" action="submit2" method="POST">
                    ...
                    <input type="hidden" name="category" value="G4_Call of Duty: Mobile">
