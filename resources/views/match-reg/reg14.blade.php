                            ...
                            <div class="show_participants" style="width:100%; text-align: center;">
                                    ...
                                    <table class="table table-dark " style="background: #7C4DFF; padding:20px;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($reg14 as $reg14)
                                            <tr>
                                            <td>
                                                @if (($reg14['team_type'] =='solo'))
                                                {{$reg14['name']}} <span>(Solo)</span>
                                                @elseif(($reg14['team_type'] =='squad'))
                                                {{$reg14['name']}} <span>(Squad)</span>
                                                @endif
                                            </td>
                                            </tr>
                                            @endforeach
