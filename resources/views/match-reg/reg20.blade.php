                            ...
                            <div class="show_participants" style="width:100%; text-align: center;">
                                    ...
                                    <table class="table table-dark " style="background: #7C4DFF; padding:20px;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($reg20 as $reg20)
                                            <tr>
                                            <td>
                                                @if (($reg20['team_type'] =='solo'))
                                                {{$reg20['name']}} <span>(Solo)</span>
                                                @elseif(($reg20['team_type'] =='squad'))
                                                {{$reg20['name']}} <span>(Squad)</span>
                                                @endif
                                            </td>
                                            </tr>
                                            @endforeach
