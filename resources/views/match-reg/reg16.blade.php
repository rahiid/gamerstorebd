                            ...
                            <div class="show_participants" style="width:100%; text-align: center;">
                                    ...
                                    <table class="table table-dark " style="background: #7C4DFF; padding:20px;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($reg16 as $reg16)
                                            <tr>
                                            <td>
                                                @if (($reg16['team_type'] =='solo'))
                                                {{$reg16['name']}} <span>(Solo)</span>
                                                @elseif(($reg16['team_type'] =='squad'))
                                                {{$reg16['name']}} <span>(Squad)</span>
                                                @endif
                                            </td>
                                            </tr>
                                            @endforeach
