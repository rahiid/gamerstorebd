                            ...
                            <div class="show_participants" style="width:100%; text-align: center;">
                                    ...
                                    <table class="table table-dark " style="background: #7C4DFF; padding:20px;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($reg10 as $reg10)
                                            <tr>
                                            <td>
                                                @if (($reg10['team_type'] =='solo'))
                                                {{$reg10['name']}} <span>(Solo)</span>
                                                @elseif(($reg10['team_type'] =='squad'))
                                                {{$reg10['name']}} <span>(Squad)</span>
                                                @endif
                                            </td>
                                            </tr>
                                            @endforeach
