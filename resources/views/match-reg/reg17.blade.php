                            ...
                            <div class="show_participants" style="width:100%; text-align: center;">
                                    ...
                                    <table class="table table-dark " style="background: #7C4DFF; padding:20px;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($reg17 as $reg17)
                                            <tr>
                                            <td>
                                                @if (($reg17['team_type'] =='solo'))
                                                {{$reg17['name']}} <span>(Solo)</span>
                                                @elseif(($reg17['team_type'] =='squad'))
                                                {{$reg17['name']}} <span>(Squad)</span>
                                                @endif
                                            </td>
                                            </tr>
                                            @endforeach
