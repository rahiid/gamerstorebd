                            ...
                            <div class="show_participants" style="width:100%; text-align: center;">
                                    ...
                                    <table class="table table-dark " style="background: #7C4DFF; padding:20px;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($reg11 as $reg11)
                                            <tr>
                                            <td>
                                                @if (($reg11['team_type'] =='solo'))
                                                {{$reg11['name']}} <span>(Solo)</span>
                                                @elseif(($reg11['team_type'] =='squad'))
                                                {{$reg11['name']}} <span>(Squad)</span>
                                                @endif
                                            </td>
                                            </tr>
                                            @endforeach
