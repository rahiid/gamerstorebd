                            ...
                            <div class="show_participants" style="width:100%; text-align: center;">
                                    ...
                                    <table class="table table-dark " style="background: #7C4DFF; padding:20px;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($reg15 as $reg15)
                                            <tr>
                                            <td>
                                                @if (($reg15['team_type'] =='solo'))
                                                {{$reg15['name']}} <span>(Solo)</span>
                                                @elseif(($reg15['team_type'] =='squad'))
                                                {{$reg15['name']}} <span>(Squad)</span>
                                                @endif
                                            </td>
                                            </tr>
                                            @endforeach
