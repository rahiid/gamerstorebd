                            ...
                            <div class="show_participants" style="width:100%; text-align: center;">
                                    ...
                                    <table class="table table-dark " style="background: #7C4DFF; padding:20px;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($reg19 as $reg19)
                                            <tr>
                                            <td>
                                                @if (($reg19['team_type'] =='solo'))
                                                {{$reg19['name']}} <span>(Solo)</span>
                                                @elseif(($reg19['team_type'] =='squad'))
                                                {{$reg19['name']}} <span>(Squad)</span>
                                                @endif
                                            </td>
                                            </tr>
                                            @endforeach
