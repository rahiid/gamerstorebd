                            ...
                            <div class="show_participants" style="width:100%; text-align: center;">
                                    ...
                                    <table class="table table-dark " style="background: #7C4DFF; padding:20px;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($reg12 as $reg12)
                                            <tr>
                                            <td>
                                                @if (($reg12['team_type'] =='solo'))
                                                {{$reg12['name']}} <span>(Solo)</span>
                                                @elseif(($reg12['team_type'] =='squad'))
                                                {{$reg12['name']}} <span>(Squad)</span>
                                                @endif
                                            </td>
                                            </tr>
                                            @endforeach
