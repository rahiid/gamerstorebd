                            ...
                            <div class="show_participants" style="width:100%; text-align: center;">
                                    ...
                                    <table class="table table-dark " style="background: #7C4DFF; padding:20px;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($reg13 as $reg13)
                                            <tr>
                                            <td>
                                                @if (($reg13['team_type'] =='solo'))
                                                {{$reg13['name']}} <span>(Solo)</span>
                                                @elseif(($reg13['team_type'] =='squad'))
                                                {{$reg13['name']}} <span>(Squad)</span>
                                                @endif
                                            </td>
                                            </tr>
                                            @endforeach
