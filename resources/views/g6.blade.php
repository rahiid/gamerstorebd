                ...
                <div id="backgroundImage" class="banner-top-up">
                    <div class="card mb-3">
                         <div class="row no-gutters banner-inner">
                           ...
                           <div class="col-md-2">
                             <img src="/image/c6.jpg" class="card-img" alt="banner-image">
                           </div>
                           <div class="col-md-9 card-right"    style="text-align: justify;">
                             <div class="card-body" >
                               <h5 class="card-title">Mobile Legends</h5>
                               <p class="card-text">Mobile Legends: Bang Bang is a mobile multiplayer online battle arena developed and published by Moonton. </p>
                               <p class="card-text"><medium class="text-muted">Region	EA <br>Platform	Mobile <br>Publisher    Moonton® </medium></p>
                             </div>
                           </div>
                         </div>
                       </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form name="game-form" action="submit2" method="POST">
                    ...
                    <input type="hidden" name="category" value="G6_Mobile Legends">
