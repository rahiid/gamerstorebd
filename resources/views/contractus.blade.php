...
<html lang="en">
<head>
  <title>Gamerstorebd | Contract Us</title>
  <meta charset="utf-8">
...
<body>
    ...
    <style>
        ...
        .contractus .contractus-inner{
            width: 100%
        }
        .contractus .contractus-inner .send-btn{
            text-align: center;
        }

        .contractus .contractus-inner .send-btn .btn{
            background-color: #7C4DFF;
            border: 2px solid #7C4DFF;
        }

        .contractus .contractus-inner .send-btn .btn:hover{
            background: transparent;
            color: #7C4DFF;

        }
        .contractus  .contractus-text{
            padding-bottom: 30px;
            text-align: center;
        }
        .contractus  .contractus-text h2{
            padding-bottom: 20px;
        }
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active"" href="/contractus"><strong>CONTRACT US</strong></a>
                        </li>
...
<!----------------------------contractus Section starts Here--------------------------->
            ...
            <div class="contractus-inner d-flex justify-content-center">
                        ...
                        <div class="col-md-12">
                            <form id="contact-form" name="contact-form" action="submit" method="POST">
                                ...
                                <div class="send-btn" style="margin-top: 30px; margin-bottom:40px;">
