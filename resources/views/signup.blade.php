...
<html lang="en">
<head>
  <title>Gamerstorebd | Sign Up</title>
  <meta charset="utf-8">
                ...
                <div class="signup-inner">
                    ...
                    <form class="signup-form">
                        <div class="form-name" >
                            ...
                            <input type="text" id="lname" class="form-control" placeholder="Last Name" style="margin-left: 5px">

                        </div>

                        <input type="text" id="login" class="form-control" name="login" placeholder="Email">
                        <input type="tel" id="number" class="form-control" placeholder="Phone Number">
                        ...
                        <div class="select-gender">
                            ...
                            <input type="radio" id="other" class="form-control"  name="gender" value="other">
                            <label for="other">Other</label>
                        </div>
                        <input type="password" id="password" class="form-control" name="login" placeholder="Password">
                        <input type="password" id="re-password" class="form-control" name="login" placeholder="Confirm Password">
                        <input type="submit" id="signup-btn" class="form-control" value="SIGN UP">
                    </form>
