                ...
                <div class="results-inner">
                    ...
                    <div id="tcard1"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body" style="padding: 0px; text-align:center; color:red;">
                            ...
                            <div class="card-body result-btn">
                              <a href="/match-results/results1"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                            </div>
                          ...
                          @forelse ($card2 as $row)
                              <div id="card2" class="card" style="width: 18rem; overflow:auto;">
                                  ...
                                  <div class="card-body wn-link">
                                    ...
                                    <div class="card-body result-btn">
                                      <a href="/match-results/results2"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                    </div>
                                </div>
                                ...
                                @forelse ($card3 as $row)
                                    <div id="card3" class="card" style="width: 18rem; overflow:auto;">
                                        ...
                                        <div class="card-body wn-link">
                                          ...
                                          <div class="card-body result-btn">
                                            <a href="/match-results/results3"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                          </div>
                                      </div>
                                      ...
                                      @forelse ($card4 as $row)
                                          <div id="card4" class="card" style="width: 18rem; overflow:auto;">
                                              ...
                                              <div class="card-body wn-link">
                                                ...
                                                <div class="card-body result-btn">
                                                  <a href="/match-results/results4"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                                </div>
                                            </div>
                                    ...
                                    @forelse ($card5 as $row)
                                        <div id="card5" class="card" style="width: 18rem; overflow:auto;">
                                            <script>
                                                ...
                                                <div class="card-body result-btn">
                                                <a href="/match-results/results5"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                                </div>
                                            </div>
                                            ...
                                            @forelse ($card6 as $row)
                                                <div id="card6" class="card" style="width: 18rem; overflow:auto;">
                                                    ...
                                                    <div class="card-body wn-link">
                                                      ...
                                                      <div class="card-body result-btn">
                                                        <a href="/match-results/results6"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                                      </div>
                                                  </div>
                                                  ...
                                                  @forelse ($card7 as $row)
                                                      <div id="card7" class="card" style="width: 18rem; overflow:auto;">
                                                          ...
                                                          <div class="card-body wn-link">
                                                            ...
                                                            <div class="card-body result-btn">
                                                              <a href="/match-results/results7"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        @forelse ($card8 as $row)
                                                            <div id="card8" class="card" style="width: 18rem; overflow:auto;">
                                                                ...
                                                                <div class="card-body wn-link">
                                                                  ...
                                                                  <div class="card-body result-btn">
                                                                    <a href="/match-results/results8"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                                                  </div>
                                                              </div>
                                                              ...
                                                              @forelse ($card9 as $row)
                                                                  <div id="card9" class="card" style="width: 18rem; overflow:auto;">
                                                                      ...
                                                                      <div class="card-body wn-link">
                                                                        ...
                                                                        <div class="card-body result-btn">
                                                                          <a href="/match-results/results9"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                                                        </div>
                                                                    </div>
                                            ...
                                            @forelse ($card10 as $row)
                                                <div id="card10" class="card" style="width: 18rem; overflow:auto;">
                                                        <script>
                                                            ...
                                                            <div class="card-body result-btn">
                                                            <a href="/match-results/results10"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    @endforeach
                                                        ...
                                                        @forelse ($card11 as $row)
                                                            <div id="card11" class="card" style="width: 18rem; overflow:auto;">
                                                                ...
                                                                <div class="card-body result-btn">
                                                                    <a href="/match-results/results11"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                                                </div>
                                                            </div>
                          ...
                          @forelse ($card12 as $row)
                              <div id="card12" class="card" style="width: 18rem; overflow:auto;">
                                  ...
                                  <div class="card-body wn-link">
                                    ...
                                    <div class="card-body result-btn">
                                      <a href="/match-results/results12"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                    </div>
                                </div>
                                ...
                                @forelse ($card13 as $row)
                                    <div id="card13" class="card" style="width: 18rem; overflow:auto;">
                                        ...
                                        <div class="card-body wn-link">
                                          ...
                                          <div class="card-body result-btn">
                                            <a href="/match-results/results13"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                          </div>
                                      </div>
                                      ...
                                      @forelse ($card14 as $row)
                                          <div id="card14" class="card" style="width: 18rem; overflow:auto;">
                                              ...
                                              <div class="card-body wn-link">
                                                ...
                                                <div class="card-body result-btn">
                                                  <a href="/match-results/results14"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                                </div>
                                            </div>
                                            ...
                                            @forelse ($card15 as $row)
                                                <div id="card15" class="card" style="width: 18rem; overflow:auto;">
                                                    ...
                                                    <div class="card-body wn-link">
                                                      ...
                                                      <div class="card-body result-btn">
                                                        <a href="/match-results/results15"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                                      </div>
                                                  </div>
                                                  ...
                                                  @forelse ($card16 as $row)
                                                      <div id="card16" class="card" style="width: 18rem; overflow:auto;">
                                                          ...
                                                          <div class="card-body wn-link">
                                                            ...
                                                            <div class="card-body result-btn">
                                                              <a href="/match-results/results16"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        @forelse ($card17 as $row)
                                                            <div id="card17" class="card" style="width: 18rem; overflow:auto;">
                                                                ...
                                                                <div class="card-body wn-link">
                                                                  ...
                                                                  <div class="card-body result-btn">
                                                                    <a href="/match-results/results17"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                                                  </div>
                                                              </div>
                                                              ...
                                                              @forelse ($card18 as $row)
                                                                  <div id="card18" class="card" style="width: 18rem; overflow:auto;">
                                                                      ...
                                                                      <div class="card-body wn-link">
                                                                        ...
                                                                        <div class="card-body result-btn">
                                                                          <a href="/match-results/results18"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    @forelse ($card19 as $row)
                                                                        <div id="card19" class="card" style="width: 18rem; overflow:auto;">
                                                                            ...
                                                                            <div class="card-body wn-link">
                                                                              ...
                                                                              <div class="card-body result-btn">
                                                                                <a href="/match-results/results19"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                                                              </div>
                                                                          </div>
                            ...
                            @forelse ($card20 as $row)
                                <div id="card20" class="card" style="width: 18rem; overflow:auto;">
                                    ...
                                    <div class="card-body result-btn">
                                        <a href="/match-results/results20"  type="button" class="btn btn-warning btn-sm">FULL RESULTS</a>
                                    </div>
                                </div>
