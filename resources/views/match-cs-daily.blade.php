...
<html lang="en">
<head>
  <title>Gamerstorebd | Daily CS Matchs</title>
  <meta charset="utf-8">
...
<!----------------------------match-cs-daily Section Starts Here--------------------------->
<section class="match-cs-daily">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="match-cs-daily-inner">
                    ...
                    <div id="card1"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                          ...
                          <a href="/match-reg/reg1" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a> <br>
                    ...
                    <div id="card2"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                          ...
                          <a href="/match-reg/reg2" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card3"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                          ...
                          <a href="/match-reg/reg3" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card4"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                          ...
                          <a href="/match-reg/reg4" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card5"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                          ...
                          <a href="/match-reg/reg5" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card6"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                          ...
                          <a href="/match-reg/reg6" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card7"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                                ...
                                <h6 class="text-muted">TOTAL SPOT: {{$count7}}/8</h6>

                          <a href="/match-reg/reg7" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a> <br>
                          <span class="text-danger small font-weight-bold">Total join maximum 8person or 2 squad. </span>
                    ...
                    <div id="card8"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                                ...
                                <h6 class="text-muted">TOTAL SPOT: {{$count8}}/8</h6>

                          <a href="/match-reg/reg8" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card9"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                                ...
                                <h6 class="text-muted">TOTAL SPOT: {{$count9}}/8</h6>

                          <a href="/match-reg/reg9" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card10"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                                ...
                                <h6 class="text-muted">TOTAL SPOT: {{$count10}}/8</h6>

                          <a href="/match-reg/reg10" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card11"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                                ...
                                <h6 class="text-muted">TOTAL SPOT: {{$count11}}/8</h6>

                          <a href="/match-reg/reg11" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card12"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                                ...
                                <h6 class="text-muted">TOTAL SPOT: {{$count12}}/8</h6>

                          <a href="/match-reg/reg12" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card13"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                                ...
                                <h6 class="text-muted">TOTAL SPOT: {{$count13}}/8</h6>

                          <a href="/match-reg/reg13" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card14"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                                ...
                                <h6 class="text-muted">TOTAL SPOT: {{$count14}}/8</h6>

                          <a href="/match-reg/reg14" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card15"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                                ...
                                <h6 class="text-muted">TOTAL SPOT: {{$count15}}/8</h6>

                          <a href="/match-reg/reg15" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card16"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                                ...
                                <h6 class="text-muted">TOTAL SPOT: {{$count16}}/8</h6>

                          <a href="/match-reg/reg16" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card17"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                                ...
                                <h6 class="text-muted">TOTAL SPOT: {{$count17}}/8</h6>

                          <a href="/match-reg/reg17" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card18"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                                ...
                                <h6 class="text-muted">TOTAL SPOT: {{$count18}}/8</h6>

                          <a href="/match-reg/reg18" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card19"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                                ...
                                <h6 class="text-muted">TOTAL SPOT: {{$count19}}/8</h6>

                          <a href="/match-reg/reg19" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
                    ...
                    <div id="card20"  class="card" style="width: 18rem;">
                        ...
                        <div class="card-body mcd-link">
                                ...
                                <h6 class="text-muted">TOTAL SPOT: {{$count20}}/8</h6>

                          <a href="/match-reg/reg20" role="button" class="btn btn-primary  btn-sm">JOIN NOW</a><br>
...
<!----------------------------match-cs-daily Section Ends Here--------------------------->
