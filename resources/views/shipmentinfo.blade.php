...
<html lang="en">
<head>
  <title>Gamerstorebd | Shipment Info</title>
  <meta charset="utf-8">
...
<body>
    ...
    <style>
        ...
        .shipmentinfo. .shipmentinfo-inner p{
            font-size: 16px;
        }
        .shipmentinfo .shipmentinfo-inner a{
            color: #7C4DFF;
        }
...
<!----------------------------shipmentinfo Section starts Here--------------------------->
<section class="shipmentinfo">
    <div class="container">
        <div class="row">
            <div class="col-md-12">

                <div class="shipmentinfo-inner" style="text-align: justify; line-height: 28px;">
                    ...
                    <p>
                        Selften Online Store supports all major shipping methods around the Bangladesh to make sure that your order reaches you in the fastest possible manner. Deliveries can take anywhere between 4 - 7 days depending on your shipping address. You can track your order using the tracking and delivery information available in your orders list.
                    </p>
                </div>
            </div>
        </div>
...
<!----------------------------shipmentinfo Section ends Here--------------------------->
