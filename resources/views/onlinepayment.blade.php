...
<html lang="en">
<head>
  <title>Gamerstorebd | Payment</title>
  <meta charset="utf-8">
...
<!----------------------------onlinepayment Section starts Here--------------------------->
<section class="onlinepayment">
    <div class="container">
        <div class="row">
            <div class="col-md-2">
                ...
                <div class="payment-inner">
                    ...
                    <div class="onlinepay">
                            ...
                            <div class="addmoney-inner">
                                    <label for="bkash">
                                    <input type="radio" id="bkash" name="addm" value="1" checked onclick='document.getElementById("addmoney-number").innerHTML = "01200700077"'>
                                    <img src="/image/bkash.jpg" alt="bkashlogo">
                                    </label>

                                    <label for="nagad">
                                    <input type="radio" id="nagad" name="addm" value="2" onclick='document.getElementById("addmoney-number").innerHTML = "01200080088"'>
                                    <img src="/image/nagad.jpg" alt="nagadlogo">
                                    </label>

                                    <label for="rocket">
                                    <input type="radio" id="rocket" name="addm" value="3" onclick='document.getElementById("addmoney-number").innerHTML = "01200090099"'>
                                    <img src="/image/rocket.jpg" alt="rocketlogo">
                                    </label>
                            </div>
                            <div class="addmoney-text">
                                <h5 id="addmoney-number">01200700077</h5>
                            ...
                            <div class="addmoney-items" >
                                <div class="form-group" >
                                    ...
                                    <input type="number" id="ammount" name="quantity" min="1" max="100000"  style="width: 100%;">
                                </div>

                                <div class="form-group">
                                    <label for="transaction">Transaction id</label> <br>
                                    <input type="text" id="txid" name="transaction" style="width: 100%;">
                                </div>
                    ...
                    <button type="button" id="cancel-btn" class="btn btn-outline-danger">Cancel Order</button>
                    <button type="button" id="confirm-btn" class="btn btn-outline-primary">Confirm Payment</button>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
...
<!----------------------------onlinepayment Section ends Here---------------------------->
