                ...
                <div id="backgroundImage" class="banner-top-up">
                    <div class="card ">
                         <div class="row no-gutters banner-inner">
                           ...
                           <div class="col-md-2">
                             <img src="/image/c1.jpg" class="card-img" alt="banner-image">
                           </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form name="game-form" action="submit2" method="POST" role="form">
                    @csrf
                    ...
                    <input type="hidden" name="category" value="G1_Free Fire_IN GAME">
                            ...
                            <li class="StepProgress-item is-done">
                                ...
                                <div class="form-group account-type">
                                    <select class="form-control"  name="account_type">
                                      ...
                                      <input name="email_number" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email/number" required>
                            ...
                            <li class="StepProgress-item is-done">
                                ...
                                <div class="form-group recharge-type">
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                        ...
                                        <div class="btn-inner">
                                            <input  value="5600 Diamond" type="radio" class="btn-check" name="product_name" id="btnradio11" onclick="display()" required>

                                            <label class="myradio btn btn-outline-primary" for="btnradio11">5600 Diamond <sup>BDT</sup> <sup id="p11">{{$row['g11']}}</sup></label>
                                        </div>


                                        <div class="btn-inner">
                                            <input  value="$0.99 Aidrop" type="radio" class="btn-check" name="product_name" id="btnradio12" onclick="display()" required>

                                            <label class="myradio btn btn-outline-primary" for="btnradio12">$0.99 Aidrop <sup>BDT</sup> <sup id="p12">{{$row['g12']}}</sup></label>
                                        </div>


                                        <div class="btn-inner">
                                            <input  value="$1.99 Airdrop" type="radio" class="btn-check" name="product_name" id="btnradio13" onclick="display()" required>

                                            <label class="myradio btn btn-outline-primary" for="btnradio13">$1.99 Airdrop <sup>BDT</sup> <sup id="p13">{{$row['g13']}}</sup></label>
                                        </div>
                                        <div class="btn-inner">
                                            <input value="$2.99 Airdrop"  type="radio" class="btn-check" name="product_name" id="btnradio14" onclick="display()" required>

                                            <label class="myradio btn btn-outline-primary" for="btnradio14">$2.99 Airdrop  <sup>BDT</sup> <sup id="p14">{{$row['g14']}}</sup></label>
                                        </div>
                                        <div class="btn-inner">
                                            <input value="Level Up Pass"  type="radio" class="btn-check" name="product_name" id="btnradio15" onclick="display()" required>

                                            <label class="myradio btn btn-outline-primary" for="btnradio15">Level Up Pass <sup>BDT</sup> <sup id="p15">{{$row['g15']}}</sup></label>
                                        </div>

                                        <div class="btn-inner">
                                            <input value="Bundle Pass" type="radio" class="btn-check" name="product_name" id="btnradio16" onclick="display()" required>

                                            <label class="myradio btn btn-outline-primary" for="btnradio16">Bundle Pass <sup>BDT</sup> <sup id="p16">{{$row['g16']}}</sup></label>
                                        </div>
                                        @endforeach
                                    </div>
                        ...
                        <table class="table table-bordered table-responsive-md">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td style="color: #7C4DFF;"><strong id="product_price">Please Select the Product First.</strong> <strong>BDT</strong></td>
