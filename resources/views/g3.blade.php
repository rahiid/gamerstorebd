                ...
                <div id="backgroundImage" class="banner-top-up">
                    <div class="card mb-3">
                         <div class="row no-gutters banner-inner">
                           ...
                           <div class="col-md-2">
                             <img src="/image/c3.jpg" class="card-img" alt="banner-image">
                           </div>
                           <div class="col-md-9 card-right"    style="text-align: justify;">
                             <div class="card-body" >
                               <h5 class="card-title">PUBG Mobile</h5>
                               <p class="card-text">ABOUT THE GAME

                                PUBG MOBILE is a Battle Royale mobile game created independently by Lightspeed & Quantum Studios of Tencent Game, officially licensed by PLAYERUNKNOWN’S BATTLEGROUNDS.  </p>
                               <p class="card-text"><medium class="text-muted">Region	EA <br>Platform	Mobile <br> Publisher	PUBG Corporation, KRAFTON, Microsoft Corporation, MORE ® </medium></p>
                             </div>
                           </div>
                         </div>
                       </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form name="game-form" action="submit2" method="POST">
                    ...
                    <input type="hidden" name="category" value="G3_PUBG_Mobile">
                        ...
                        <ul class="StepProgress">
                            ...
                            <li class="StepProgress-item is-done">
                                ...
                                <div class="form-group account-type">
                                    <select class="form-control " style="width: 100%" name="account_type">
