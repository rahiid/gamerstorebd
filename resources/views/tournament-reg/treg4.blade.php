                            ...
                            <div class="show_participants" style="width:100%; text-align: center;">
                                    ...
                                    <table class="table table-dark " style="background: #7C4DFF; padding:20px;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($treg4 as $treg4)
                                            <tr>
                                            <td>
                                                @if (($treg4['team_type'] =='solo'))
                                                {{$treg4['name']}} <span>(Solo)</span>
                                                @elseif(($treg4['team_type'] =='squad'))
                                                {{$treg4['name']}} <span>(Squad)</span>
                                                @endif
                                            </td>
                                            </tr>
                                            @endforeach
