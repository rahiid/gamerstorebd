                            ...
                            <div class="show_participants" style="width:100%; text-align: center;">
                                    ...
                                    <table class="table table-dark " style="background: #7C4DFF; padding:20px;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($treg1 as $treg1)
                                            <tr>
                                            <td>
                                                @if (($treg1['team_type'] =='solo'))
                                                {{$treg1['name']}} <span>(Solo)</span>
                                                @elseif(($treg1['team_type'] =='squad'))
                                                {{$treg1['name']}} <span>(Squad)</span>
                                                @endif
                                            </td>
                                            </tr>
                                            @endforeach
