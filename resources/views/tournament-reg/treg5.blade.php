                            ...
                            <div class="show_participants" style="width:100%; text-align: center;">
                                    ...
                                    <table class="table table-dark " style="background: #7C4DFF; padding:20px;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($treg5 as $treg5)
                                            <tr>
                                            <td>
                                                @if (($treg5['team_type'] =='solo'))
                                                {{$treg5['name']}} <span>(Solo)</span>
                                                @elseif(($treg5['team_type'] =='squad'))
                                                {{$treg5['name']}} <span>(Squad)</span>
                                                @endif
                                            </td>
                                            </tr>
                                            @endforeach
