                            ...
                            <div class="show_participants" style="width:100%; text-align: center;">
                                    ...
                                    <table class="table table-dark " style="background: #7C4DFF; padding:20px;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($treg2 as $treg2)
                                            <tr>
                                            <td>
                                                @if (($treg2['team_type'] =='solo'))
                                                {{$treg2['name']}} <span>(Solo)</span>
                                                @elseif(($treg2['team_type'] =='squad'))
                                                {{$treg2['name']}} <span>(Squad)</span>
                                                @endif
                                            </td>
                                            </tr>
                                            @endforeach
