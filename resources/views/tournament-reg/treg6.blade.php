                            ...
                            <div class="show_participants" style="width:100%; text-align: center;">
                                    ...
                                    <table class="table table-dark " style="background: #7C4DFF; padding:20px;">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($treg6 as $treg6)
                                            <tr>
                                            <td>
                                                @if (($treg6['team_type'] =='solo'))
                                                {{$treg6['name']}} <span>(Solo)</span>
                                                @elseif(($treg6['team_type'] =='squad'))
                                                {{$treg6['name']}} <span>(Squad)</span>
                                                @endif
                                            </td>
                                            </tr>
                                            @endforeach
