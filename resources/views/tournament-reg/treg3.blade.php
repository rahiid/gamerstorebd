                        ...
                        @if(Auth::check())
                            ...
                            <div class="show_participants" style="width:100%; text-align: center;">
                                    ...
                                    <table class="table table-dark " style="background: #7C4DFF; padding:20px;">
                                        ...
                                        <tbody>
                                            @foreach ($treg3 as $treg3)
                                            <tr>
                                            <td>
                                                @if (($treg3['team_type'] =='solo'))
                                                {{$treg3['name']}} <span>(Solo)</span>
                                                @elseif(($treg3['team_type'] =='squad'))
                                                {{$treg3['name']}} <span>(Squad)</span>
                                                @endif
                                            </td>
                                            </tr>
                                            @endforeach
